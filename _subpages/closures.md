...
layout: default
title: "Closures"
description: A Swift closures reference guide, covering inline closures, closures as variables, closure typealiases, and @escaping closures.
redirect_from:
  - /closure/
...
* [Closures `📖 Official Swift Book`](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/closures/)
